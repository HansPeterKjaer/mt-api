<?php 
  $size = 'strength-cardio-icon--' . (isset($viewModel['size']) ? $viewModel['size'] : 'sm'); 
  $diff = isset($viewModel['diff']) ? intval($viewModel['diff']) : 3;
  $delay = ($diff-1) * 2;
?>
...
<svg
   ...
   width="200"
   height="100"
   class="strength-cardio-icon <?php echo $size; ?>"
   viewBox="0 0 200 100">
  <path
     id="path4151"
     d="M 170,74 C 170,30 130,30 130,74" 
     class="bump" 
     style="animation-delay:-0.<?php echo $delay ?>s;" />
  <path
     id="path5244"
